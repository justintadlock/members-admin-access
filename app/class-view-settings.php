...
class View_Settings extends View {
	...
	function register_settings() {
		...
		add_settings_section( 'general', esc_html__( 'Admin Access', 'members-admin-access' ), array( $this, 'section_general' ), app()->namespace . '/settings' );

		/* === Settings Fields === */

		add_settings_field( 'select_roles', esc_html__( 'Select Roles', 'members-admin-access' ), array( $this, 'field_select_roles' ), app()->namespace . '/settings', 'general' );
		add_settings_field( 'redirect',     esc_html__( 'Redirect',     'members-admin-access' ), array( $this, 'field_redirect'     ), app()->namespace . '/settings', 'general' );
		add_settings_field( 'toolbar',      esc_html__( 'Toolbar',      'members-admin-access' ), array( $this, 'field_toolbar'      ), app()->namespace . '/settings', 'general' );
	}
	...
	public function section_general() { ?>
		...
		<p class="description">
			<?php esc_html_e( 'Control admin access by user role.', 'members-admin-access' ); ?>
		</p>
	<?php }
	...
	public function field_select_roles() { ?>
		...
		<p class="description">
			<?php esc_html_e( 'Select which roles should have admin access.', 'members-admin-access' ); ?>
		</p>
	...
	public function field_redirect() { ?>
		...
		<p>
			<label>
				<?php esc_html_e( 'Redirect users without access to:', 'members-admin-access' ); ?>
	...
	public function field_toolbar() { ?>
		...
		<p>
			<label>
				...
				<?php esc_html_e( 'Disable toolbar on the front end for users without admin access.', 'members-admin-access' ); ?>
			</label>
		</p>
	<?php }
	...
	public function template() { ?>
		...
		<form method="post" action="options.php">
			...
			<?php submit_button( esc_attr__( 'Update Settings', 'members-admin-access' ), 'primary' ); ?>
		</form>
